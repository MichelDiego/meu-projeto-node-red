.nrdb-debug-view{margin:12px;max-width:1200px}.nrdb-debug-view h1{display:flex;flex-direction:row;align-items:center;justify-content:space-between}.nrdb-debug-description{font-size:.85rem;padding:16px}.debug-filters{display:flex;flex-direction:row;align-items:center;justify-content:flex-start;margin:16px}.debug-filters label{margin-right:1rem}.debug-filters-chips{display:flex;gap:8px;align-items:center}.nested-table,.nested-table .v-table{background-color:#eee}[data-v-102ce503] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px);--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-102ce503]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--flex[data-v-102ce503]{--layout-card-width: 320px;--layout-gap: 12px}.nrdb-layout--flex[data-v-102ce503]{display:flex;flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--flex>div[data-v-102ce503]{width:var(--layout-card-width);max-width:100%}.v-card[data-v-102ce503]{width:100%}[data-v-b0f2bdcd] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px);--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-b0f2bdcd]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--grid[data-v-b0f2bdcd]{--layout-card-width: 320px;--layout-gap: 12px;--widget-row-height: 48px}.nrdb-layout--grid[data-v-b0f2bdcd]{display:grid;grid-template-columns:repeat(12,1fr);flex-wrap:wrap;padding:var(--page-padding);gap:var(--group-gap)}.nrdb-layout--grid>div[data-v-b0f2bdcd]{width:100%}.v-card[data-v-b0f2bdcd]{width:100%}@media only screen and (max-width: 1024px){.nrdb-layout--grid[data-v-b0f2bdcd]{grid-template-columns:repeat(9,1fr)}}@media only screen and (max-width: 768px){.nrdb-layout--grid[data-v-b0f2bdcd]{grid-template-columns:repeat(6,1fr)}}[data-v-15f14374] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px);--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}.nrdb-layout-group--grid[data-v-15f14374]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;gap:var(--widget-gap)}.nrdb-layout--notebook[data-v-15f14374]{--layout-card-width: 1024px;--layout-gap: 12px}.nrdb-layout--notebook[data-v-15f14374]{margin:auto;width:100%;max-width:var(--layout-card-width);min-height:100%;flex-wrap:wrap;padding:var(--page-padding)}.nrdb-layout--notebook>div[data-v-15f14374]{width:100%;margin-bottom:var(--group-gap)}.v-card[data-v-15f14374]{width:100%}.nrdb-btn-icon{display:flex;align-items:center;justify-content:center}.nrdb-btn-icon .v-btn.v-btn--density-default{height:calc(var(--v-btn-height) + 12px)}.nrdb-ui-button .v-btn .v-icon{--v-icon-size-multiplier: 1}.nrdb-ui-button-group-wrapper[data-v-2b1cfa80]{display:flex;flex-direction:row;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px}.nrdb-ui-button-group-wrapper .v-chip__content[data-v-2b1cfa80]{white-space:normal}.nrdb-ui-button-group-wrapper .v-btn-group[data-v-2b1cfa80]{width:max-content;border-width:thin;border-color:rgba(var(--v-border-color),var(--v-border-opacity))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated[data-v-2b1cfa80]{color:rgb(var(--v-theme-on-group-background));background-color:rgb(var(--v-theme-group-background))}.nrdb-ui-button-group-wrapper .v-btn--variant-elevated[data-v-2b1cfa80]{--v-activated-opacity: 0}.nrdb-ui-button-group-wrapper .icon-only .v-btn__prepend[data-v-2b1cfa80]{margin-inline:0}.nrdb-ui-gauge svg{flex-grow:1;max-width:100%;position:relative}.nrdb-ui-gauge-title{display:block;text-align:center;font-weight:700;font-size:1rem;padding-bottom:4px}.nrdb-ui-gauge-value{position:absolute;width:100%;height:100%;display:flex;align-content:center;justify-content:center;flex-direction:column;text-align:center;flex-wrap:wrap;padding-top:6px}.nrdb-ui-gauge-value span{font-weight:700}.nrdb-ui-gauge-value label{display:flex;align-items:center;justify-content:center}.nrdb-ui-gauge #backdrop path{fill:rgb(var(--v-theme-background))}.nrdb-ui-gauge #sections path{stroke:rgb(var(--v-theme-group-background));stroke-width:2px}.nrdb-ui-gauge #limits{opacity:.5;fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge #needle-container{pointer-events:none}.nrdb-ui-gauge #needle-mask{opacity:0}.nrdb-ui-gauge #needle circle,.nrdb-ui-gauge #needle polygon{fill:rgb(var(--v-theme-on-group-background))}.nrdb-ui-gauge-value span{font-size:2.5rem;line-height:2.75rem}.nrdb-ui-gauge-value label{font-size:.75rem;line-height:.825rem}.nrdb-ui-gauge-size-1 .nrdb-ui-gauge-value span{font-size:1rem;line-height:1.25rem}.nrdb-ui-gauge-size-2 .nrdb-ui-gauge-value span{font-size:1.5rem;line-height:1.75rem}.nrdb-ui-gauge-size-3 .nrdb-ui-gauge-value span{font-size:2rem;line-height:2.25rem}.nrdb-ui-gauge-tile[data-v-f2a59060]{display:flex;justify-content:center;align-items:center;font-size:2.5rem;font-weight:700;transition:.15s background-color;border:1px solid rgb(var(--v-theme-group-outline))}.nrdb-ui-gauge{position:relative}/*!
  Theme: Default
